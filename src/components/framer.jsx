...
export function FramerCMDK() {
  ...
  const data = [
    ...
    {
      value: "Get random image by category",
      type: "info",
      subtitle: "/api/random/[category]",
      icon: <RadioIcon />,
      snippet: <RandomImageByCategory />,
    },
    {
      value: "Get specific image",
      type: "info",
      subtitle: "/api/images/[id]",
      icon: <RadioIcon />,
      snippet: <SpecificImage />,
    },
    {
    ...
    {
      value: "Get all images by category",
      type: "info",
      subtitle: "/api/categories/[type]",
      icon: <InputIcon />,
      snippet: <AllImagesByCategory />,
    },

    {
      value: "Resize image",
      subtitle: "w by h, square, ratios",
      icon: <BadgeIcon />,
      snippet: <ComingSoon />,
      version: "future",
    },
            ...
            <div cmdk-framer-right="">
              {data.map((item, i) => (
                <div key={i} className="wrapper">
                  {value === item.value.toLowerCase() && item.snippet}
                </div>
              ))}
            </div>
          </div>
...
function Item({ children, value, subtitle, type }) {
  ...
  return (
    <Command.Item value={value} onSelect={() => {}}>
      <div cmdk-framer-icon-wrapper="" style={{ background: bkgType() }}>
        {children}
      </div>
